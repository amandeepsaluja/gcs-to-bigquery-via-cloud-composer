...
variable "name" {
  ...
  type        = string
  default     = "trigger-airflow-dag"
}

variable "description" {
  description = "User-provided description of a function."
  type        = string
  default     = "Cloud function to trigger airflow dag"
}
...
variable "cf_trigger_bucket_path" {
  type    = string
  default = "projects/_/buckets/data-bucket-gcp-practice-project-aman/objects/raw-excel-airflow/*.xlsx"
}
